...
# **IBI Overview**
This report provides a summary of the biotic integrity of `r params$user_title`, based on macroinvertebrate organisms collected on `r macroibi:::add_ordinal_suffix(params$user_date, style = "%m/%d/%Y")`. The Index of Biotic Integrity (IBI) method seeks to quantify
