...
- **LaTeX** (optional, for PDF exports) --- Install TinyTeX after MacroIBI:
  ```r
  install.packages("tinytex")
  tinytex::install_tinytex()
  ```
- **Chrome or Chromium** (optional, for PNG table image export)
...
- **Table Image (PNG)** --- formatted metric table (requires Chrome)
- **Data Summary (PDF)** --- concise one-page snapshot (requires LaTeX)
- **Full Report (PDF)** --- comprehensive report with comparisons to other
  autosaved sessions (requires LaTeX)
