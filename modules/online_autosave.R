...
autosave_module_ui <- function(id) {
  ns <- shiny::NS(id)
  shiny::tagList(
    shiny::uiOutput(ns("autosave_warning")),
...
autosave_module_server <- function(
  ...
  shiny::moduleServer(id, function(input, output, session) {
    ...
    output$autosave_warning <- shiny::renderUI({
      shiny::HTML("The autosave feature is not available online. You may still load old autosaves as sample data. Please run the app locally if you would like to generate new autosaves.")
    })
